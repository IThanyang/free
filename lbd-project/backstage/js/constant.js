...
app.constant('modal',{
  //成功提示
  success:{name:'成功',title:'操作N股成功',content:'是否执行下架操作'},
  //上下架
  status:[
	{name:'下架',title:'下架后该职位信息将不再在前台展示',content:'是否执行下架操作'},
	{name:'上架',title:'上架后该职位信息将不再在前台展示',content:'是否执行上架操作'}
  ],
  //删除
  delete:[
	{name:'公司删除',title:'删除后该公司职位信息将被删除',content:'是否执行删除操作'},
	{name:'职位删除',title:'删除后该职位信息将无法使用及还原',content:'是否执行删除操作'},
	{name:'Article删除',title:'删除后该Article图将直接下架并在本地删除',content:'是否执行删除操作'},
	{name:'删除',content:'是否执行删除操作'}
	],
	//冻结
	freezed:[
	  {name:'冻结',title:'冻结后该公司下的所有信息将不可用',content:'是否执行冻结操作'},
	  {name:'解冻',title:'解冻后该公司下的信息将可继续使用',content:'是否执行冻结操作'}
	],
  	//认证
  	approved:[
	  {name:'认证',title:'认证后该公司将被标记为推荐公司',content:'是否执行认证操作'},
	  {name:'解除',title:'解除认证后该公司将不再标记为推荐公司',content:'是否执行解除操作'}
	],
  	//上下线
  	online:[
	  {name:'下线',title:'下线后图片将不在前台进行展示',content:'是否执行下线操作'},
	  {name:'上线',title:'上线后图片将会在前台进行展示',content:'是否执行上线操作'}
	]
});